...
- Branch copies content with `structuredClone` (preserves `undefined`, `bigint`, `Date`, `Map`/`Set`, circular graphs); uncloneable values fail as typed `BranchProcessorError`, not defects.
